...
return new class extends Migration
{
    ...
    {
        Schema::table('spatial_riol_line', function (Blueprint $table) {
            $table->dropForeign(['jalan_tol_id']);
        });
        Schema::dropIfExists('spatial_riol_line');
    }
};
